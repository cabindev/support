 ...
 try {
   ...
   const userEmailHtml = `
     ...
     <head>
       <meta charset="UTF-8">
       <meta name="viewport" content="width=device-width, initial-scale=1.0">
       <title>ยืนยันคำขอสื่อรณรงค์</title>
       <style>
         body { font-family: 'Helvetica', 'Arial', sans-serif; line-height: 1.6; color: #333; }
         .container { max-width: 600px; margin: 0 auto; padding: 20px; }
     ...
     <body>
       <div class="container">
         ...
         <div class="content">
           <h1 style="color: #f58220;">ยืนยันการส่งคำขอสื่อรณรงค์</h1>
           <p>เรียน คุณ${firstName} ${lastName}</p>
           <p>ขอบคุณสำหรับคำขอสื่อรณรงค์ของท่าน เราได้รับข้อมูลเรียบร้อยแล้ว และจะดำเนินการตรวจสอบโดยเร็วที่สุด</p>
           
           <h3>รายละเอียดคำขอ:</h3>
           <ul>
             <li><strong>หมายเลขคำขอ:</strong> #${mediaRequest.id}</li>
             <li><strong>หัวข้อ:</strong> ${subject}</li>
             <li><strong>วันที่ส่งคำขอ:</strong> ${new Date().toLocaleDateString('th-TH', { year: 'numeric', month: 'long', day: 'numeric' })}</li>
           </ul>
           
           <p>ทีมงานของเราจะติดต่อกลับไปที่เบอร์โทรศัพท์ ${phoneNumber} หรืออีเมล ${email} ในกรณีที่ต้องการข้อมูลเพิ่มเติม</p>
           
           <p>หากมีข้อสงสัยประการใด สามารถติดต่อเราได้ที่ <a href="mailto:contact@sdnthailand.com">contact@sdnthailand.com</a> หรือโทร 02-948-3300</p>
         </div>
         <div class="footer">
           <p>สำนักงานเครือข่ายองค์กรงดเหล้า (สคล.) มุ่งมั่นส่งเสริมและสนับสนุนการดำเนินงานในทุกภาคส่วนของสังคม เพื่อลดผลกระทบและความเสี่ยงจากการบริโภคเครื่องดื่มแอลกอฮอล์ ร่วมสร้างสรรค์สังคมไทยให้เข้มแข็งและปลอดภัยอย่างยั่งยืน</p>
           <p>© 2024 SDN Thailand. All rights reserved.</p>
   ...
   await transporter.sendMail({
     ...
     to: "evo_reaction@hotmail.com, tom_teera@hotmail.com, tan66847@gmail.com, chainarong880@gmail.com, eakarinsaisunee@gmail.com",
   ...
   await transporter.sendMail({
     from: '"SDN Thailand" <sdnthailandbackup@gmail.com>',
     to: email, // อีเมลของผู้ใช้จาก session
     subject: "ยืนยันการส่งคำขอสื่อรณรงค์",
     html: userEmailHtml,
     attachments: [
       {
         filename: 'logo.png',
